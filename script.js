...
//Text
    if (search==="text") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else if (search==="Text" || search==="text css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
...
//Color
    ...
    else if (search==="Color" || search==="color css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
...
//Background
    ...
    else if (search==="Background" || search==="background css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
...
//Size
    ...
    else if (search==="Size" || search==="size css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
...
//Border-radius
    if (search==="border-radius") {
        window.open("https://povrty.github.io/CSS", "_blank");
    }
    else if (search==="Border-radius" || search==="border-radius css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
...
//Opacity
    ...
    else if (search==="Opacity" || search==="opacity css") {
        window.open("https://Povrty.github.io/CSS", "_blank");
    }
    else {
         window.open("https://www.google.com/search?q="+search, "_blank");
